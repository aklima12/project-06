...
<body>
<div class="container-fluid m-o p-o"> 
    <div class="row"> 
        <div class="col-sm-12 clo-md-12 col-lg-3 col-xl-2 col-xxl-2">
            <ul class="list-group">
                ...
                <li class="list-group-item"><a class="d-block nav-link" style= data-bs-toggle="collapse" href="#collapseExample" role="button"aria-expanded="false"aria-controls="collapseExample">Admission</a>
